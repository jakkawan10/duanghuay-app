...
export default function IntraPage() {
  ...
  const ref = doc(db, 'intra', roundKey);
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center p-6">
      <h1 className="text-3xl font-bold mb-2">🧘‍♂️ เจ้าองค์อินทร์แสนดี</h1>
      <p className="text-sm text-gray-400 mb-6">
        ท่านคือเทพแห่งเมตตา ความดีงาม และการคุ้มครองผู้ศรัทธา
      </p>
      ...
      <div className="bg-white text-black rounded-xl p-4 w-full max-w-md mb-6">
        ...
        {renderInput('3 ตัวมณีเวทยมนต์', 'threeDigit', 'เช่น 562 801')}
