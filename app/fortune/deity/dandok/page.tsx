...
export default function DandokPage() {
  ...
  const ref = doc(db, 'dandok', roundKey);
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center p-6">
      <h1 className="text-3xl font-bold mb-2">✨ เจ้าแม่ดานดอกษ์ศ์ ✨</h1>
      <p className="text-sm text-gray-400 mb-6">
        เทพหญิงแห่งความรู้ การเจริญงอกงาม และการเปลี่ยนแปลงทางจิตวิญญาณ
      </p>
      ...
      <div className="bg-white text-black rounded-xl p-4 w-full max-w-md mb-6">
        ...
        {renderInput('3 ตัวแม่ดานดอกษ์ศ์', 'threeDigit', 'เช่น 562 801')}
