...
export default function ManeewitchPage() {
  ...
  const ref = doc(db, 'maneewitch', roundKey);
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center p-6">
      <h1 className="text-3xl font-bold mb-2">✨ เจ้ามณีเวทยมนต์ ✨</h1>
      <p className="text-sm text-gray-400 mb-6">
        เทพแห่งเวทย์มนต์ ความลี้ลับ และการดลบันดาลโชคแบบเหนือธรรมชาติ
      </p>
      ...
      <div className="bg-white text-black rounded-xl p-4 w-full max-w-md mb-6">
        ...
        {renderInput('3 ตัวเจ้ามณีเวทย์', 'threeDigit', 'เช่น 562 801')}
        {renderInput('4 ตัวขลังเวทย์', 'fourDigit', 'เช่น 7520 9851')}
        {renderInput('5 ตัวดลใจ', 'fiveDigit', 'เช่น 15897 30006')}
